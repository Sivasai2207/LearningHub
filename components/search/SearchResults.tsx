                ...
                <section className="space-y-4">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        {results.courses.map((c: any) => (
                            <Link key={c.id} href={ROUTES.tenant(tenantSlug).admin.courseDetail(c.id)}>
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-2">
                        {results.modules.map((m: any) => (
                            <Link key={m.id} href={ROUTES.tenant(tenantSlug).admin.modules(m.course_id)} className="block">
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-2">
                        {results.content.map((i: any) => (
                            <Link key={i.id} href={ROUTES.tenant(tenantSlug).admin.content(i.module_id)} className="block">
                                <div className="p-3 border rounded-lg bg-white hover:bg-gray-50 flex items-center justify-between group">
